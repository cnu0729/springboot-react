...
public class PostServiceImpl implements PostService{
	...
	// file.upload-dir=C:/Users/user1/Desktop/savaImage 경로 넣어서 사용
	...
	public void uploadImages(MultipartFile[] files, String title, String content) {
		...
		// 이미지 이름 설정과 이미지 경로 생성한 것을 바탕으로 데이터베이스에 넣어주기
		Post post = new Post();
		post.setTitle(title);
